...
object DongMatrix {
    ...
    private fun writeManifest(
        ...
        // ⚠️ **노선 수를 적지 않는다.** "13개 노선"이라고 박아뒀다가 코레일 광역철도
        //    시각표가 들어오면서 하루 만에 틀렸다. 자료가 늘 때마다 여기가 조용히 낡는다.
        sb.append("  \"warning\": \"지하철은 노선에 따라 실측 시각표" +
            "(서울교통공사·철도데이터포털) 또는 배차간격 기반 합성 시간표다. " +
            "버스는 합성이다. 어느 쪽인지는 GTFS 생성 로그에 찍힌다.\",\n")
