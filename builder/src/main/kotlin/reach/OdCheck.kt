 ...
 * ## 왜 행렬을 그대로 안 읽나
 *
 * 배포 행렬은 표본 K개의 **중앙값** 하나만 들고 있다. 그 값이 카카오보다 크게 나왔을 때
 ...
 *
 * ⚠️ **"망이 맞다"까지만 말한다.** min 이 카카오보다 작아도 그건 "어느 출발 분에는
 * 그만큼 빠르다"는 뜻이지 우리 중앙값이 맞다는 뜻이 아니다. 중앙값이 옳은지는
 * 카카오를 여러 시각에 여러 번 물어 **분포끼리** 대야 알 수 있고, 그건 아직 안 했다.
 *
